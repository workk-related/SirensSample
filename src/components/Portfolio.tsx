...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="relative overflow-hidden">
      {/* Wave Divider */}
      <div className="wave-divider bg-gradient-to-b from-deep-current to-aqua-dream">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path d="M0,0V7.23C0,65.52,268.63,112.77,600,112.77S1200,65.52,1200,7.23V0Z" className="wave" fill="rgba(123, 196, 196, 0.6)"></path>
          ...
          <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" opacity=".25" className="wave" fill="rgba(123, 196, 196, 0.2)"></path>
        </svg>
      </div>
      
      <div className="py-24 bg-gradient-to-b from-aqua-dream via-mystic-waters to-deep-current relative">
